        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    FavListId = table.Column<Guid>(type: "uniqueidentifier", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_FavListProducts", x => x.Id);
                    table.ForeignKey(
                        name: "FK_FavListProducts_FavLists_FavListId",
                        column: x => x.FavListId,
                        principalTable: "FavLists",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_FavListProducts_Products_ProductId",
                        column: x => x.ProductId,
                        principalTable: "Products",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_FavListProducts_FavListId_ProductId",
                table: "FavListProducts",
                columns: new[] { "FavListId", "ProductId" },
                unique: true,
                filter: "[FavListId] IS NOT NULL AND [ProductId] IS NOT NULL");

            migrationBuilder.CreateIndex(
                name: "IX_FavListProducts_ProductId",
                table: "FavListProducts",
                column: "ProductId");
